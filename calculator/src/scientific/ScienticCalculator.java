 ...
 * @author Vicky Raj
 */
public class ScienticCalculator extends javax.swing.JFrame {

    /**
     * Creates new form ScienticCalculator
     */
  ...
  double t=Math.cos(Double.parseDouble(jTextField1.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScienticCalculator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScienticCalculator().setVisible(true);
            }
        });
    }
